            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center py-6 justify-center w-full h-full bg-gradient-to-t from-MidNightBlack">
                        ...
                        <div className="">
                            ...
                            <div className="">
                                <div className=" py-4 font-cascadia-normal text-Snow pb-4 text-xs h-20 lg:h-auto">
                                    <span>{"<"}<span className="text-Green sm:text-base xl:text-lg font-bold">h2</span>
                                        ...
                                        </span> {"</"}<span className="text-Green sm:text-base xl:text-lg font-bold">/h2</span>{">"} </span>
                                </div>
                            </div>
                            {/* <Link to='portfolio' spy={true} smooth={true} duration={500} offset={-50} className="button">Portfolio</Link> */}
                        </div>
                        <div className="w-60 h-40 relative hidden md:block" style={{ borderRadius: '1rem' }}>
                            {/* <img className='absolute top-8 w-full h-full' src="images/Hello.jpg" alt="hello" /> */}
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 md:gap-0 md:flex items-center justify-between w-full px-4 xl:px-8 2xl:px-16">
                    ...
                    <div className="flex items-center gap-x-1">
                        <span className='text-base md:text-lg text-Green font-bold'>21+</span>
